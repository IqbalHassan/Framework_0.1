...
urlpatterns = patterns('',
    ...
    # Run Test Page
    url(r'^Home/ManageMilestone/$',manageMilestone),
    url(r'^Home/RunTest/$', RunTest),
    url(r'^Home/.*/AutoMileStone/$', AutoMileStone),
    url(r'^Home/ManageMilestone/MileStoneOperation/$', MileStoneOperation),
    ...
    url(r'^Home/CreateBug/$',CreateBug),
    url(r'^Home/CreateBug/(?P<bug_id>[^/]*)/$', EditBug),
    url(r'^Home/.*/LogNewBug/$',LogBug),
