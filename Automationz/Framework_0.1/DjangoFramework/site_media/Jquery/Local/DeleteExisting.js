$(document).ready(function(){
	...
	indx = URL.indexOf("Run");
			...
			AddAutoCompleteSearchBox("#Place_AutoComplete_Here", "Enter the name of Test Case to be deleted:");
...
//    $("#verify_cvs").css("border", "2px solid black");  
//    var element = document.getElementById("cvs");
//    var ctx = element.getContext("2d");
//                
//    $("#verify_cvs").click(function() {
//        element.width = element.width;
//        var random_string = Math.random().toString(36).substring(2, 7);
//        ctx.font = "30px Arial";
//        ctx.fillText(random_string, 10, 40);
//    });
//	
});
					...
					+ "<tbody>"					
						...
						+ "<tr>"
							+ "<td>"
								...
								+ Label
								+ " </b></label>"
								+ "<input class = 'ui-corner-all' id='searchbox' style = 'margin-left:-2%' type='text' title = 'Please Type Keyword and Click On that to add to query' name='TC_Id' />"
							+ "</td>"
						+ "</tr>"
						...
						$.get("Table_Data_TestCases",{Query: UserText, Env: Env},function(data) {
											...
											else 
											{
												...
												$(".editBtn").click(function (){
													...
													var random_string = Math.random().toString(36).substring(2, 7);
													var r = window.prompt("Do you really want to delete the Test Case?\nType in the following word: " + random_string);
													if (r === random_string) {
														window.location = '/Home/ManageTestCases/DeleteExisting/?TC_Id='+ $(this).attr("id");
													}
													$(this).css("opacity", "1");
												});
