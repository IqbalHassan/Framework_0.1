...
def Send_Email(Receiver, Subject, Objective, Tester, StartDate, EndDate, EstimatedTime, Body=None , type=None):
    ...
    html = """<div id=":1ox" class="ii gt m146ced87dfe81da1 adP adO">
        ...
        </div>""" % (Subject, Objective, Subject, Subject, Objective, 'Submitted', Tester, StartDate, EndDate, EstimatedTime)
...
def Pending_Email(Receiver, Subject, Objective, Status, List, Tester,Duration, Body=None , type=None):
    from mailer import Mailer
    from mailer import Message
