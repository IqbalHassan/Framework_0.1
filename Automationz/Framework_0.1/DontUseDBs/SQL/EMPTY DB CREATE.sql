...
ALTER TABLE public."Platform_PlatformID_seq" OWNER TO postgres;
...
ALTER TABLE public."TestStep_TestStepID_seq" OWNER TO postgres;
...
ALTER TABLE public.branch_management OWNER TO postgres;
...
ALTER TABLE public.bugid_seq OWNER TO postgres;
...
ALTER TABLE public.comment_track OWNER TO postgres;
...
ALTER TABLE public.commentid_seq OWNER TO postgres;
...
ALTER TABLE public.components_map OWNER TO postgres;
...
ALTER TABLE public.config_values OWNER TO postgres;
...
ALTER TABLE public.config_values_id_seq OWNER TO postgres;
...
ALTER TABLE public.containertypedata_id_seq OWNER TO postgres;
...
ALTER TABLE public.container_type_data OWNER TO postgres;
...
ALTER TABLE public.daily_build_status OWNER TO postgres;
...
ALTER TABLE public.daily_build_status_id_seq OWNER TO postgres;
...
ALTER TABLE public.default_choice OWNER TO postgres;
...
ALTER TABLE public.dependency_management OWNER TO postgres;
...
ALTER TABLE public.dependency_name OWNER TO postgres;
...
ALTER TABLE public.dependency_name_id_seq OWNER TO postgres;
...
ALTER TABLE public.dependency_values OWNER TO postgres;
...
ALTER TABLE public.executionlog_executionlogid_seq OWNER TO postgres;
...
ALTER TABLE public.expectedcontainer_expectedplaylistid_seq OWNER TO postgres;
...
--
-- Name: feature_management; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.feature_management OWNER TO postgres;
...
ALTER TABLE public.feature_map OWNER TO postgres;
...
ALTER TABLE public.label_map OWNER TO postgres;
...
ALTER TABLE public.labelid_seq OWNER TO postgres;
...
ALTER TABLE public.machine_dependency_settings OWNER TO postgres;
...
ALTER TABLE public.machine_project_map OWNER TO postgres;
...
ALTER TABLE public.milestone_info OWNER TO postgres;

--
-- Name: milestone_team_map; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE milestone_team_map (
    milestone_id integer,
    team_id integer
);


ALTER TABLE public.milestone_team_map OWNER TO postgres;
...
--
-- Name: COLUMN performance_results.id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: performanceresults_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.performanceresults_id_seq OWNER TO postgres;

--
-- Name: performanceresults_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE performanceresults_id_seq OWNED BY performance_results.id;
...
ALTER TABLE public.permitted_user_list OWNER TO postgres;
...
ALTER TABLE public.permitted_user_list_user_id_seq OWNER TO postgres;
...
ALTER TABLE public.product_sections_section_id_seq OWNER TO postgres;
...
ALTER TABLE public.project_team_map OWNER TO postgres;
...
ALTER TABLE public.projectid_seq OWNER TO postgres;
...
ALTER TABLE public.requirement_sections OWNER TO postgres;
...
ALTER TABLE public.requirement_sections_requirement_path_id_seq OWNER TO postgres;
...
--
-- Name: requirement_team_map; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE requirement_team_map (
    requirement_id character varying(10),
    team_id character varying(10)
);


ALTER TABLE public.requirement_team_map OWNER TO postgres;
...
ALTER TABLE public.requirementid_seq OWNER TO postgres;
...
ALTER TABLE public.result_container_type_data OWNER TO postgres;
...
ALTER TABLE public.result_master_data OWNER TO postgres;
...
ALTER TABLE public.result_test_case_datasets OWNER TO postgres;
...
ALTER TABLE public.result_test_case_tag OWNER TO postgres;
...
ALTER TABLE public.result_test_cases OWNER TO postgres;
...
ALTER TABLE public.result_test_steps OWNER TO postgres;
...
ALTER TABLE public.result_test_steps_data OWNER TO postgres;
...
ALTER TABLE public.result_test_steps_list OWNER TO postgres;
...
ALTER TABLE public.task_sections OWNER TO postgres;
...
ALTER TABLE public.task_sections_task_path_id_seq OWNER TO postgres;
...
ALTER TABLE public.taskid_seq OWNER TO postgres;
...
ALTER TABLE public.team_info OWNER TO postgres;
...
ALTER TABLE public.team_wise_settings OWNER TO postgres;
...
ALTER TABLE public.test_case_datasets OWNER TO postgres;
...
ALTER TABLE public.testresults_id_seq OWNER TO postgres;
...
ALTER TABLE public.test_case_tag OWNER TO postgres;
...
ALTER TABLE public.test_env_results OWNER TO postgres;
...
ALTER TABLE public.test_run_env OWNER TO postgres;
...
ALTER TABLE public.teststepresults_id_seq OWNER TO postgres;
...
ALTER TABLE public.test_step_results OWNER TO postgres;
...
ALTER TABLE public.teststepstemp_teststepsequence_seq OWNER TO postgres;
...
ALTER TABLE public.test_steps_data OWNER TO postgres;
...
ALTER TABLE public.test_steps_list OWNER TO postgres;
...
ALTER TABLE public.testcase_testcaseid_seq OWNER TO postgres;
...
ALTER TABLE public.testenvresults_id OWNER TO postgres;
...
ALTER TABLE public.testenvresults_id_seq OWNER TO postgres;
...
ALTER TABLE public.testrun_id_seq OWNER TO postgres;
...
ALTER TABLE public.testrunenv_id_seq OWNER TO postgres;
...
ALTER TABLE public.teststepdata_id_seq OWNER TO postgres;
...
ALTER TABLE public.teststeps_stepsid_seq OWNER TO postgres;
...
ALTER TABLE public.teststepslist_step_id_seq OWNER TO postgres;
...
ALTER TABLE public.teststepstemp_id_seq OWNER TO postgres;
...
ALTER TABLE ONLY performance_results ALTER COLUMN id SET DEFAULT nextval('performanceresults_id_seq'::regclass);
...
--
-- Name: performanceresults_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY performance_results
    ADD CONSTRAINT performanceresults_pkey PRIMARY KEY (id);
...
--
-- Name: unique_key_feature; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY feature_management
    ADD CONSTRAINT unique_key_feature UNIQUE (project_id, team_id, feature);
...
ALTER TABLE ONLY dependency
    ADD CONSTRAINT unique_name UNIQUE (dependency_name);
...
ALTER TABLE ONLY product_features
    ADD CONSTRAINT unique_name_feature UNIQUE (feature_path);
...
ALTER TABLE ONLY performance_results
    ADD CONSTRAINT performanceresults_tc_id_fkey FOREIGN KEY (tc_id) REFERENCES test_cases(tc_id);
...
--
-- Name: requirement_team_map; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY requirement_team_map
    ADD CONSTRAINT requirement_team_map FOREIGN KEY (requirement_id) REFERENCES requirements(requirement_id);
